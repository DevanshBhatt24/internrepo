...
TextStyle headline5White = GoogleFonts.ibmPlexSans(
    fontSize: 25, fontWeight: FontWeight.w400, color: almostWhite);

TextStyle headline5WhiteBold = GoogleFonts.ibmPlexSans(
    fontSize: 25, fontWeight: FontWeight.w600, color: almostWhite);
...
TextStyle newsPulseStyle = GoogleFonts.ibmPlexSans(
    color: white60,
    fontSize: 16,
    fontWeight: FontWeight.w500,
    letterSpacing: 0.15);
