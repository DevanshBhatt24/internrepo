...
class Week52LowPage extends StatefulWidget {
  Week52LowPage({Key key}) : super(key: key);

  @override
  _Week52LowPageState createState() => _Week52LowPageState();
}

class _Week52LowPageState extends State<Week52LowPage>
  ...
  _fetchApi() async {
    stockData = await StockServices2.get52WeekLow();
    // stockData.bse  =stoc
    setState(() {
      loading = false;
    });
