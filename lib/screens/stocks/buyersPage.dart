...
class _BuyersPageState extends State<BuyersPage>
  ...
  List<String> menu = [];
  List<BuyerSeller> bseBuyers, nseBuyers;

  _fetchapi() async {
    bseBuyers = await StockServices.getBuyers('bse');
    nseBuyers = await StockServices.getBuyers('nse');
    setState(() {});
    ...
    return Material(
      child: Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: Column(
              children: [
                AppBarWithBack(text: 'Only Buyers'),
                TabBar(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              return TabBarView(controller: _controller, children: [
                bseBuyers != null ? section(context, bseBuyers) : LoadingPage(),
                nseBuyers != null ? section(context, nseBuyers) : LoadingPage(),
              ]);
            },
          ),
        ),
