...
class GainersPage extends StatefulWidget {
  GainersPage({Key key}) : super(key: key);

  @override
  _GainersPageState createState() => _GainersPageState();
}

class _GainersPageState extends State<GainersPage>
  ...
  _fetchApi() async {
    stockData = await StockServices2.getTopGainers();
    // stockData.bse  =stoc
    setState(() {
      loading = false;
    });
