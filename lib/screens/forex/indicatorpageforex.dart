...
class IndicatorPageForex extends StatefulWidget {
  final bool stocks;
  final String query;
  IndicatorPageForex({Key key, this.stocks = false, this.query})
      : super(key: key);
...
class _IndicatorPageState extends State<IndicatorPageForex> {
  // TextStyle _headStyle = TextStyle(
  //   fontSize: 12,
  //   color: darkGrey.withOpacity(0.60),
  // );
  //
  ForexExploreTechnicalIndicator indicator;
  ...
  fetchApi() async {
    technicalIndicator =
        await ForexServices.getForexTechnicalIndicator(widget.query);
    selectedTimeObject =
  ...
  The15Min getTimeObject(int index, ForexExploreTechnicalIndicator i) {
    switch (index) {
      case 0:
        return i.the1Min;
      case 1:
                        ...
                        child: Column(
                          children: [
                            ...
                            Column(
                                children: List.generate(
                              _s1 == 0
                                  ? selectedTimeObject?.movingAverages
                            ...
                            SizedBox(height: 30),
                            FlatButton(
                              color: determineColor(selectedTimeObject
                                      ?.technicalIndicator?.text ??
                                  ""),
                              onPressed: () {},
                              minWidth: 48,
                              height: 28,
